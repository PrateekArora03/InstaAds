      ...
      <footer className="post-footer-section">
        <div className="activity-section">
          <span className="like-section">
            ...
            <span className="like-count">132 likes</span>
          </span>
        ...
        <div className="description-section">
          <span className="description-author">Prateek</span>
          <span className="description-data">
            Top 7 resources to learn python!Top 7 resources to learn python!Top
            7 resources to learn python!Top 7 resources to learn python!
          </span>
        </div>
      </footer>
    </article>
